...
if (typeof YAHOO.lacuna.MapperS == "undefined" || !YAHOO.lacuna.MapperS) {
...
(function(){
    ...
    MapperS.MovableContainer = function( parentEl ) {
    ...
    MapperS.MovableContainer.prototype = {
        move : function( x,y ) {
            this.offsetX += x;
            this.offsetY += y;
    ...
    MapperS.VisibleArea = function(map) {
        this._map = map;
        this.reset();
    };
    MapperS.VisibleArea.prototype = {
        move : function(mx,my) {
    ...
    MapperS.StarTile = function(x, y, z, ox, oy, layer) {
        MapperS.StarTile.superclass.constructor.call(this, x, y, z, ox, oy, layer);
    };
    Lang.extend(MapperS.StarTile, Tile, {
        init : function() {
    ...
    MapperS.PlanetTile = function(x, y, z, ox, oy, layer) {
        MapperS.PlanetTile.superclass.constructor.call(this, x, y, z, ox, oy, layer);
        Dom.addClass(this.domElement, "tile"+ this.tileSizeInPx);
    };
    Lang.extend(MapperS.PlanetTile, Tile, {
        init : function() {
        ...
        refresh : function() {
            MapperS.PlanetTile.superclass.refresh.call(this);
            this.init();
        },
        appendToDom : function() {
        ...
        remove : function() {
            this.stopTick();
            MapperS.PlanetTile.superclass.remove.call(this);
        },
    ...
    MapperS.StarTileLayer = function(map, visibleArea, TileConstructor) {
        MapperS.StarTileLayer.superclass.constructor.call(this, map, visibleArea, TileConstructor);
    };
    Lang.extend(MapperS.StarTileLayer, TileLayer, {
    ...
    MapperS.PlanetTileLayer = function(map, visibleArea, TileConstructor) {
        this.bounds = {x1:map.maxBounds.x1Left,x2:map.maxBounds.x2Right,y1:map.maxBounds.y1Top,y2:map.maxBounds.y2Bottom};

        MapperS.PlanetTileLayer.superclass.constructor.call(this, map, visibleArea, TileConstructor);
    };
    Lang.extend(MapperS.PlanetTileLayer, TileLayer, {
        _showCachedTiles : function() {
            if(this.tileCache) {
    ...
    var Map = function( divId, options ) {
        ...
        this.movableContainer = new MapperS.MovableContainer( this.mapDiv );

        this.init();

        var ua = navigator.userAgent;
        if(ua.match(/iPhone|iPod|iPad/i)) {
            this.controller = new MapperS.iPhoneController( this );
        }
        else {
            this.controller = new MapperS.TraditionalController( this );
        }
    };
    Map.prototype = {
        //blank init that will always get called.  override in sub classes to change defaults
        ...
        zoomIn : function() {
            //YAHOO.log("zooming in", "info", "MapperS.Map");
        ...
        zoomOut : function() {
            //YAHOO.log("zooming out", "info", "MapperS.Map");
        ...
        redraw : function() {
            ...
            this.visibleArea = new MapperS.VisibleArea(this);

            if( this.tileLayer ) {
                this.tileLayer.destroy();
            }
            this.tileLayer = new this.TileLayer(this, MapperS.util.clone(this.visibleArea), this.Tile);
            //pass through
    ...
    MapperS.StarMap = function( divId, options ) {
        MapperS.StarMap.superclass.constructor.call(this, divId, options);
        Dom.setStyle(this.mapDiv, 'background-image', 'url("'+Lib.AssetUrl+'star_system/field.png")');
    };
    Lang.extend(MapperS.StarMap, Map, {
        ...
        init : function() {
            ...
            this.Tile = MapperS.StarTile;
            this.TileLayer = MapperS.StarTileLayer;
    ...
    MapperS.PlanetMap = function( divId, options ) {
        MapperS.PlanetMap.superclass.constructor.call(this, divId);
        this.setSurfaceUrl(options.surfaceUrl);
    };
    Lang.extend(MapperS.PlanetMap, Map, {
        _setTileSizeByZoom : function() {
        ...
        init : function() {
            ...
            this.Tile = MapperS.PlanetTile;
            this.TileLayer = MapperS.PlanetTileLayer;
    ...
    MapperS.TraditionalController = function( map ) {
        this.map = map;
        this.dd = new YAHOO.util.DragDrop(map.mapDiv, 'mappers' );
    ...
    MapperS.TraditionalController.prototype = {
    ...
    MapperS.iPhoneController = function(map) {
        this.map = map;
        this.currentX = 0;
        this.currentY = 0;
    ...
    MapperS.iPhoneController.prototype = {
    ...
    YAHOO.lacuna.MapperS = MapperS;
})();
YAHOO.register("mappers", YAHOO.lacuna.MapperS, {version: "1", build: "0"});
